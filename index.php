...
<body>
    <section>
        <div class="wrapper">
            <?php
            foreach ($faq as $questionTitle) {
                echo '<h1>' . $questionTitle['question'] . '</h1>';
                echo $questionTitle['answer'];
            }
            ?>
        </div>
    </section>
